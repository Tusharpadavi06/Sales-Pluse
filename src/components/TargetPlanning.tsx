            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-zinc-900 text-white">
                  <th className="p-4 text-left text-[10px] font-black uppercase tracking-widest sticky top-0 md:sticky md:left-0 bg-zinc-900 z-20 md:z-30 w-12 text-center">#</th>
                  <th className="p-4 text-left text-[10px] font-black uppercase tracking-widest min-w-[200px] sticky top-0 md:sticky md:left-12 bg-zinc-900 z-20 md:z-30 border-r border-zinc-800">Customer Name</th>
              ...
              <tbody className="divide-y divide-zinc-100">
                {displayRows.map((row, index) => (
                  <tr key={row.id} className="hover:bg-zinc-50 transition-colors group">
                    <td className="p-4 text-xs font-black text-zinc-300 relative md:sticky md:left-0 bg-white group-hover:bg-zinc-50 z-10 text-center border-r border-zinc-100/50">{index + 1}</td>
                    <td className="p-4 relative md:sticky md:left-12 bg-white group-hover:bg-zinc-50 z-10 border-r border-zinc-150 min-w-[200px]">
                      <Input 
