             ...
             <table className="w-full border-collapse">
              <thead>
                <tr className="bg-zinc-100 border-b-2 border-zinc-200">
                  <th className="p-4 text-left text-xs font-black uppercase tracking-widest text-zinc-800 sticky top-0 md:sticky md:left-0 bg-zinc-100 z-20 md:z-30 md:shadow-[2px_0_5px_-2px_rgba(0,0,0,0.05)] border-r border-zinc-200/85 min-w-[240px] md:min-w-[280px]">
                    Entity Context
                  </th>
                  {MONTHS.map(month => (
                ...
                {displayEntries.map((entry) => {
                  ...
                  return (
                    <tr key={entry.id} className="hover:bg-zinc-50/40 transition-colors group">
                      <td className="p-4 relative md:sticky md:left-0 bg-white md:shadow-[3px_0_12px_-5px_rgba(0,0,0,0.12)] z-10 border-r border-zinc-100 min-w-[240px] md:min-w-[280px]">
